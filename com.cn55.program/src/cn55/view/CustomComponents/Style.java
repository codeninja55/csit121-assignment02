...
public class Style {
    ...
    public static Font toolbarButtonFont() { return new Font("Verdana", Font.BOLD, 27); }
    public static Font labelFont() { return new Font("Monospaced", Font.BOLD, 18); }
    ...
    public static Font textFieldFont() { return new Font("Monospaced", Font.PLAIN, 18); }
